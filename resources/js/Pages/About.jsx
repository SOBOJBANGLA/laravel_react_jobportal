            ...
            <div className="col-lg-6 col-md-6 mb-5">
                <div className="about-left">
                    <div className="position-relative shadow rounded img-one">
                        <img src="images/about/ab01.jpg" className="img-fluid rounded" alt=""/>
                    </div>

                    <div className="img-two shadow rounded p-2 bg-white">
                        <img src="images/about/ab02.jpg" className="img-fluid rounded" alt=""/>
        ...
        <div className="row">
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-12 mt-4 pt-2">
                <div className="position-relative features text-center p-4 rounded shadow bg-white">
                    ...
                    <div className="mt-4">
                        <a href="" className="title h5 text-dark">Apply with confidence</a>
                        <p className="text-muted mt-3 mb-0">Many desktop publishing now use and a search for job.</p>
                        <div className="mt-3">
                            <a href="" className="btn btn-link primary text-dark">Read More <i className="mdi mdi-arrow-right"></i></a>
                        </div>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-12 mt-4 pt-2">
                <div className="position-relative features text-center p-4 rounded shadow bg-white">
                    ...
                    <div className="mt-4">
                        <a href="" className="title h5 text-dark">Reduce Hiring Bias</a>
                        <p className="text-muted mt-3 mb-0">Many desktop publishing now use and a search for job.</p>
                        <div className="mt-3">
                            <a href="" className="btn btn-link primary text-dark">Read More <i className="mdi mdi-arrow-right"></i></a>
                        </div>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-12 mt-4 pt-2">
                <div className="position-relative features text-center p-4 rounded shadow bg-white">
                    ...
                    <div className="mt-4">
                        <a href="" className="title h5 text-dark">Proactive Employers</a>
                        <p className="text-muted mt-3 mb-0">Many desktop publishing now use and a search for job.</p>
                        <div className="mt-3">
                            <a href="" className="btn btn-link primary text-dark">Read More <i className="mdi mdi-arrow-right"></i></a>
                        </div>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 col-12 mt-4 pt-2">
                <div className="position-relative features text-center p-4 rounded shadow bg-white">
                    ...
                    <div className="mt-4">
                        <a href="" className="title h5 text-dark">No Missed Opportunities</a>
                        <p className="text-muted mt-3 mb-0">Many desktop publishing now use and a search for job.</p>
                        <div className="mt-3">
                            <a href="" className="btn btn-link primary text-dark">Read More <i className="mdi mdi-arrow-right"></i></a>
                        </div>
        ...
        <div className="row g-4 mt-0">
                ...
                <div className="card team team-primary text-center">
                    <div className="card-img team-image d-inline-block mx-auto rounded-pill avatar avatar-ex-large overflow-hidden">
                        ...
                        <ul className="list-unstyled team-social mb-0">
                            <li className="list-inline-item"><a href="javascript:void(0)" className="btn btn-sm btn-pills btn-icon"><i data-feather="facebook" className="icons fea-social"></i></a></li>
                            <li className="list-inline-item"><a href="javascript:void(0)" className="btn btn-sm btn-pills btn-icon"><i data-feather="instagram" className="icons fea-social"></i></a></li>
                            <li className="list-inline-item"><a href="javascript:void(0)" className="btn btn-sm btn-pills btn-icon"><i data-feather="twitter" className="icons fea-social"></i></a></li>
                        </ul>{/*end icon*/}
                    </div>

                    <div className="content mt-3">
                        <a href="page-team-detail.html" className="text-dark h5 mb-0 title">Jack John</a>
            ...
            <div className="col-lg-3 col-md-4 col-12">
                <div className="card team team-primary text-center">
                    ...
                    <div className="content mt-3">
                        <a href="page-team-detail.html" className="text-dark h5 mb-0 title">Krista John</a>
                        <h6 className="text-muted mb-0 fw-normal">Job Seeker</h6>
                    </div>
                </div>
            </div>{/*end col*/}
            ...
            <div className="col-lg-3 col-md-4 col-12">
                <div className="card team team-primary text-center">
                    ...
                    <div className="content mt-3">
                        <a href="page-team-detail.html" className="text-dark h5 mb-0 title">Roger Jackson</a>
                        <h6 className="text-muted mb-0 fw-normal">Job Seeker</h6>
                    </div>
                </div>
            </div>{/*end col*/}
            ...
            <div className="col-lg-3 col-md-4 col-12">
                <div className="card team team-primary text-center">
                    ...
                    <div className="content mt-3">
                        <a href="page-team-detail.html" className="text-dark h5 mb-0 title">Johnny English</a>
                        <h6 className="text-muted mb-0 fw-normal">Job Seeker</h6>
                    </div>
                </div>
            </div>{/*end col*/}
        ...
        <div className="row mt-md-5 pt-md-3 mt-4 pt-2 justify-content-center">
            <div className="col-12 text-center">
                <div className="section-title">
                    ...
                    <a href="contactus.html" className="btn btn-primary mt-3"><i className="uil uil-phone"></i> Contact us</a>
                </div>
            </div>{/*end col*/}
        </div>{/*end row*/}
    </div>
